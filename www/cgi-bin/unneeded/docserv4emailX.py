...
print('<img border="0" src="/images/email.jpg" width="50" height="50" align="middle"/>.')
...
if chart is None:
	...
	for row in c:
	 ...
	 tableC from email.mime.image import MIMEImage
from email.mime.multipart import MIMEMultipartontent = tableContent + '<tr class="alt">'
	...
	if tableContent == '':
	 ...
	 sendmailsms(mailtxt)
	 print('<br><h2>Thank you and have a nice day!<h2>')
